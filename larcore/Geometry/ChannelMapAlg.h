...
namespace geo{
 ...
 public:
    ...
    * optical detector can have anywhere between 2 and 12 channels, the returned
    * value is 12 times NOpDets, and it will be an overestimation of the number
    * of channels.
    */
    ...
    * single channel on each optical detector, the return value will be 1, again
    * ignoring opDet (this is in fact the fallback implementation). If each
    * optical detector can have anywhere between 2 and 12 channels, the returned
    * value will be 2, 12, etc., that is the exact number of channels in opDet.
    * 
   ...
   /**
    * @brief Returns the sensitive auxiliary detector closest to specified point
    * @param point coordinates of the position to be investigated (x, y, z)
