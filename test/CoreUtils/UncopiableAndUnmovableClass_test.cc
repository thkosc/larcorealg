...
BOOST_AUTO_TEST_CASE(UncopiableAndUnmovableClassTest)
{
  ...
  BOOST_TEST(!std::is_copy_constructible<lar::UncopiableAndUnmovableClass>::value);
  BOOST_TEST(!std::is_copy_assignable<lar::UncopiableAndUnmovableClass>::value);
  BOOST_TEST(!std::is_move_constructible<lar::UncopiableAndUnmovableClass>::value);
  BOOST_TEST(!std::is_move_assignable<lar::UncopiableAndUnmovableClass>::value);
  ...
  struct MovableDerived : protected lar::UncopiableAndUnmovableClass {
    MovableDerived(MovableDerived&&) : lar::UncopiableAndUnmovableClass() {}
  };
